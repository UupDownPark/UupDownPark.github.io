...
const Career = () => {
  return (
    <section className="bg-cyan-300 w-full flex flex-col justify-center items-center">
...
>>>>>>> 110734591d0f1c688c2e46d660cff59bf0d737fe
          ...
          <ul className="list-disc p-6 space-y-2">
            ...
            <li className="font-noto-sans">SVN를 활용한 개발 이력 관리</li>
            <li className="font-noto-sans">Spring framework 개발 방식</li>
            <li className="font-noto-sans">고객사 컴플레인 처리</li>
          </ul>
        </div>
      </div>
    </section>
