...
const Skills = () => {
  return (
    <section
      id="skills"
      className="bg-green-500 w-full flex flex-col justify-center items-center"
    >
      ...
      <div
        id="skillsContainer"
        className="max-w-7xl py-16 content-around flex flex-col flex-wrap max-xl:flex-nowrap xl:h-[180vh] 2xl:h-[100vh]"
      >
        <div
