          ...
          <div className="flex flex-row max-2xl:flex-col mt-6">
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="m-6 max-w-xl min-w-80 border-b-[1px] mb-2">
                ...
                공용 컴포넌트를 만들었습니다.
                <br />그 외에 마이페이지, 개인정보 수정, 선호도 수정, 회원탈퇴,
                로그아웃 ,일기 태그 수정 등을 구현하였습니다.
                <div className="h-5"></div>
          ...
          <div className="flex flex-row max-2xl:flex-col mt-6">
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="m-6 max-w-xl min-w-80 border-b-[1px] mb-2">
                ...
                <div className="h-5"></div>
                라우팅 구성 및 중첩 라우팅 구성, React-Redux를 통한 State 관리,
                react-slick 이용한 메인페이지 자동 슬라이드 구현 및 디자인, 매장
                상세 페이지 매장 위치 기반 카카오 지도, 마이페이지 (점주회원),
